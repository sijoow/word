...
const wordLists = {
    ...
    8: [
        { word: "吸う", kana: "すう", meaning: "들이마시다" },
        { word: "払う", kana: "はらう", meaning: "지불하다" },
        { word: "拾う", kana: "ひろう", meaning: "줍다" },
        { word: "笑う", kana: "わらう", meaning: "웃다" },
        { word: "預かる", kana: "あずる", meaning: "보관하다" },
        { word: "受かる", kana: "うかる", meaning: "합격하다" },
        { word: "掛かる", kana: "かかる", meaning: "걸리다" },
        { word: "助かる", kana: "たすかる", meaning: "살아나다" },
        { word: "上がる", kana: "あかる", meaning: "오르다" },
        { word: "怖がる", kana: "こわがる", meaning: "무서워하다" },
        { word: "表す", kana: "あらわす", meaning: "표현하다" },
        { word: "移す", kana: "うつす", meaning: "옮기다" },
        { word: "返す", kana: "かえす", meaning: "돌려주다" },
        { word: "隠す", kana: "かくす", meaning: "숨기다" },
        { word: "示す", kana: "しめす", meaning: "나타내다" },
        { word: "回す", kana: "まわす", meaning: "돌리다" },
        { word: "勝つ", kana: "かす", meaning: "기다" },
        { word: "経つ", kana: "たつ", meaning: "경과하다" },
        { word: "遊ぶ", kana: "あそぶ", meaning: "놀다" },
        { word: "転ぶ", kana: "ころぶ", meaning: "넘어지다" },
        { word: "運ぶ", kana: "はこぶ", meaning: "옮기다" },
        { word: "結ぶ", kana: "むすぶ", meaning: "묶다" },
        { word: "決まる", kana: "きまる", meaning: "정해지다" },
        { word: "泊まる", kana: "とまる", meaning: "묵다" },
        { word: "編む", kana: "あむ", meaning: "엮다, 짜다" },
        { word: "組む", kana: "くむ", meaning: "짜다, 끼다" },
        { word: "包む", kana: "つつむ", meaning: "포장하다" },
        { word: "悩む", kana: "なやむ", meaning: "괴로워하다" },
        { word: "配る", kana: "くばる", meaning: "나누어 주다" },
        { word: "断る", kana: "ことわる", meaning: "거절하다" },
        { word: "困る", kana: "こまる", meaning: "곤란하다" },
        { word: "叱る", kana: "しかる", meaning: "야단치다" },
        { word: "黙る", kana: "だまる", meaning: "말을 하지 않다" },
        { word: "握る", kana: "にぎる", meaning: "잡다, 쥐다" },
        { word: "終える", kana: "おえる", meaning: "끝마치다" },
        { word: "覚える", kana: "おぼえる", meaning: "기억하다" },
        { word: "替える", kana: "かえる", meaning: "교체하다" },
        { word: "換える", kana: "かえる", meaning: "교환하다" },
        { word: "加える", kana: "くわえる", meaning: "더하다" },
        { word: "支える", kana: "ささえる", meaning: "버티다" },
        { word: "伝える", kana: "つたえる", meaning: "전하다" },
        { word: "生える", kana: "はえる", meaning: " (풀, 머리가) 나다" },
        { word: "冷える", kana: "ひえる", meaning: " 차가워지다"},
        { word: "燃える", kana: "もえる", meaning: "  타다"},
        { word: "預ける’", kana: "あずける", meaning: "  맡기다"},
        { word: "助ける’", kana: "たすける", meaning: "  구조하다"},
        { word: "訪ねる", kana: "たずねる", meaning: "  방문하다"},
        { word: "跳ねる", kana: "はねる", meaning: "  뛰다"},
        { word: "比べる", kana: "くらべる", meaning: "  비교하다"},
        { word: "調べる", kana: "しらべる", meaning: "  조사하다"},
    ...
    9: [
       ...
       },     
       {
        ...
        {
            word: "タックスフリのカウンターはどこにありますか?",
            kana: "탁쿠수후리노 카운토-와 도코니 아리마스까", 
            meaning: "텍스프리 카운터는 어디있나요?"
        },      
        {
            word: "カードもいいですか?",
            kana: "", 
        ...
        {
            word: "近くにコンビニはありますか?",
            kana: "치카쿠니 콘비니와 아리마스까?", 
            meaning: "근처에 편의점이 있나요"
        },        
        {
            word: "お箸",
            kana: "오하시", 
